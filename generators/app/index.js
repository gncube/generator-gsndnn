  ...
  prompting() {
    ...
    this.log(
      chalk.italic.white("This tool is forked, with love, from the original ") +
        ...
        chalk.italic.white(
          " maintained by the most honorable Matt Rutledge.\n\n"
        )
    );
    ...
    const prompts = [
      ...
      },
      {
        ...
        name: "dnnHost",
        message:
          "What is the URL to your local DNN site? (currently only used by SPA templates)",
      ...
      },
      {
        ...
        name: "dnnRoot",
        message:
          "What is the local path to the root of your DNN site? (currently only used by SPA templates)",
        default: process.cwd(),
        store: true,
        validate: str => {
          return str.length > 0;
