...
<%@ Register TagPrefix="dnn" TagName="SOCIALICON" src="~/DesktopModules/GSN/SocialIcons/View.ascx" %>
<%@ Register TagPrefix="dnn" TagName="GSNLANGUAGE" src="~/DesktopModules/GSN/Language/Language.ascx" %>
<%@ Register TagPrefix="dnn" TagName="GSNSEARCH" src="~/DesktopModules/GSN/Search/Search.ascx" %>
<%@ Register TagPrefix="dnn" TagName="ACCOUNTVIEW" src="~/DesktopModules/GSN/AccountView/Account.ascx" %>
